...
describe('RedisBinaryDownloadUrl', () => {
  describe('getDownloadUrl()', () => {
    describe('for mac', () => {
      it('latest', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/osx/redis-macos-x86_64-latest.tgz'
        );
      });
      ...
      it('4.4', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/osx/redis-macos-x86_64-4.4.0.tgz'
        );
      });
      ...
      it('above 3.0', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/osx/redis-osx-ssl-x86_64-3.6.3.tgz'
        );
      });
      ...
      it('below and include 3.0', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/osx/redis-osx-x86_64-3.0.0.tgz'
        );
      });
    });
    ...
    it('for ubuntu', async () => {
      ...
      expect(await du.getDownloadUrl()).toBe(
        'https://fastdl.redis.org/linux/redis-linux-x86_64-ubuntu1404-3.6.3.tgz'
      );
    });
    ...
    it('for debian', async () => {
      ...
      expect(await du.getDownloadUrl()).toBe(
        'https://fastdl.redis.org/linux/redis-linux-x86_64-debian81-3.6.3.tgz'
      );
    });
    ...
    describe('for win32 & windows', () => {
      it('3.6 (win32)', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/win32/redis-win32-x86_64-2008plus-ssl-3.6.3.zip'
        );
      });
      ...
      it('4.0.14 (win32)', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/win32/redis-win32-x86_64-2008plus-ssl-4.0.14.zip'
        );
      });
      ...
      it('4.2 (win32)', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/win32/redis-win32-x86_64-2012plus-4.2.0.zip'
        );
      });
      ...
      it('4.4 (windows)', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/windows/redis-windows-x86_64-4.4.0.zip'
        );
      });
      ...
      it('latest (windows)', async () => {
        ...
        expect(await du.getDownloadUrl()).toBe(
          'https://fastdl.redis.org/windows/redis-windows-x86_64-latest.zip'
        );
      });
    });
    ...
    it('fallback', async () => {
      ...
      expect(await du.getDownloadUrl()).toBe(
        'https://fastdl.redis.org/linux/redis-linux-x86_64-3.6.3.tgz'
      );
  ...
  describe('getUbuntuVersionString()', () => {
    const downloadUrl = new RedisBinaryDownloadUrl({
      platform: 'linux',
      arch: 'x64',
      version: '3.6.3',
    });
    ...
    it('should return a archive name for Ubuntu 18.04', () => {
      const oldRedisVersion = downloadUrl.version;
      ...
      downloadUrl.version = oldRedisVersion;
    });
  });
